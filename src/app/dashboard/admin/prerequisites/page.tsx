      ...
      {isLoading ? (
        ...
        <Card className="border border-dashed border-slate-200 bg-white shadow-lg rounded-2xl overflow-hidden">
          <CardContent className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-sm text-slate-500 mt-2 mb-8 max-w-md font-medium">Create your first prerequisite document to get started with patient onboarding resources.</p>
        ...
        <div className="flex flex-col gap-3">
          <AnimatePresence>
            {documents.map((document: DashboardDocument, index: number) => (
              ...
              >
                <Card className="border border-slate-200 bg-white shadow-sm hover:shadow-md transition-shadow rounded-lg overflow-hidden">
                  <div className="flex items-center p-4 gap-4">
                    {/* Document icon */}
                    <div className="flex-shrink-0">
                      {document.thumbnail_url ? (
                        <div className="w-12 h-12 rounded-lg overflow-hidden bg-slate-50 border border-slate-200">
                          <img
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 text-xs text-slate-500">
                            ...
                            <span className={cn(
                              "font-medium",
                              document.access_type === "free" ? "text-slate-600" : "text-amber-600"
                            )}>
                            ...
                            <span className={cn(
                              "font-medium",
                              document.is_active ? "text-emerald-600" : "text-slate-400"
                            )}>
                        ...
                        <div className="flex items-center gap-1.5 shrink-0">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            className="h-8 w-8 p-0 text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded-md"
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            className="h-8 w-8 p-0 text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-md"
