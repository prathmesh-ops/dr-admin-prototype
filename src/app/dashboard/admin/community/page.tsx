      ...
      <div className="space-y-6 p-8 min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 rounded-[50px]">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {Array.from({ length: 4 }).map((_, idx) => (
            <Card key={`stat-skel-${idx}`} className="border-0 bg-white/70 shadow-lg">
          ...
          <CardContent>
            <div className="space-y-3">
              {Array.from({ length: 5 }).map((_, idx) => (
                <div key={`post-skeleton-${idx}`} className="rounded-2xl border border-slate-100 bg-white/70 p-4">
    ...
    <div className="space-y-6 p-8 min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 rounded-[50px]">
      ...
      {/* <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Link href="/dashboard/admin/community/posts">
          <Card className="border border-slate-200/80 bg-white hover:shadow-lg transition-shadow cursor-pointer">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                <p className="font-semibold text-slate-900">Posts Management</p>
                <p className="text-sm text-slate-600">Manage all community posts</p>
              </div>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/dashboard/admin/community/moderation">
          <Card className="border border-slate-200/80 bg-white hover:shadow-lg transition-shadow cursor-pointer">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                <p className="font-semibold text-slate-900">Moderation Requests</p>
          ...
          <Card className="border border-slate-200/80 bg-white hover:shadow-lg transition-shadow cursor-pointer">
            <CardContent className="p-6 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">Monitor user violations</p>
              </div>
            </CardContent>
          </Card>
        </Link>
          ...
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-3xl font-bold text-slate-900">{stats.activePosts}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-3xl font-bold text-slate-900">{stats.hiddenPosts}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-3xl font-bold text-slate-900">{stats.deletedPosts}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-3xl font-bold text-slate-900">{stats.autoHiddenByAI}</p>
          ...
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-3xl font-bold text-slate-900">{stats.activeAuthors}</p>
                <p className="text-xs text-slate-700 mt-2">Content creators</p>
              </div>
      ...
      <Card className="border-0 bg-white shadow-sm">
        <CardContent className="p-4">
            <div className="flex flex-col gap-4 w-full md:flex-row md:items-center">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-9 h-10 bg-slate-50 border-slate-200 min-w-max"
                />
              </div>
              
              {/* Media Type */}
              <Select value={mediaTypeFilter} onValueChange={setMediaTypeFilter}>
                <SelectTrigger className="h-14 w-full bg-slate-50 border-slate-200">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-9 w-full h-10 bg-slate-50 border-slate-200"
                />
              </div>
            ...
            <div className="flex justify-end pt-2">
              <Button variant="ghost" size="sm" className="text-slate-600" onClick={handleResetFilters}>
                  ...
                  <TableRow key={post.id} className="hover:bg-slate-50/50">
                    ...
                    <TableCell>
                      <div className="max-w-[100px]">
                        <p className="font-semibold text-slate-900 truncate">{post.author_name}</p>
                        {/* <p className="text-xs text-slate-500">{post.author_user_id}</p> */}
                      </div>
                    </TableCell>
                    <TableCell>
                      <p
          ...
          {selectedPost && (
            <div className="h-full">
              ...
              <div className="bg-white">
                ...
                <div className="p-4 flex items-center justify-between border-b border-slate-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">{getTimeAgo(selectedPost.created_at)}</p>
                    </div>
                  </div>
                          ...
                          {selectedPost.media.map((mediaItem, idx) => (
                            <button
                              ...
                              className={`h-16 w-16 flex-shrink-0 overflow-hidden rounded-lg border ${
                                idx === mediaIndex ? "border-slate-900" : "border-slate-200"
                              }`}
                            >
                ...
                <div className="p-4 space-y-4">
                  ...
                  <div className="flex items-center gap-4 py-2 border-y border-slate-100">
                    <Button
                      variant="ghost"
                      className={`flex-1 gap-2 ${liked ? "text-rose-600" : "text-slate-600"}`}
                      onClick={handleLike}
                    >
                      <Heart className={`h-5 w-5 ${liked ? "fill-rose-600" : ""}`} />
                      Like
                    </Button>
                    <Button variant="ghost" className="flex-1 gap-2 text-slate-600">
                      ...
                      <div key={comment.id} className="flex gap-3">
                        ...
                        <div className="flex-1 bg-white rounded-lg p-3 border border-slate-200">
                          ...
                          <div className="flex items-center gap-3 mt-2 text-xs">
                            <span className="text-slate-500">{comment.likesCount} likes</span>
              ...
              <div className="p-4 bg-slate-50 border-t">
                <h3 className="font-semibold text-slate-900 mb-3 text-sm">Post Admin Actions</h3>
                <div className="flex gap-2">
