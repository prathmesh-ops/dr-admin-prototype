          ...
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-3xl font-bold text-slate-900">{stats.withHidden}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-3xl font-bold text-slate-900">{stats.withDeleted}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-3xl font-bold text-slate-900">{stats.frequentViolators}</p>
              </div>
                ...
                {users.map((user) => {
                  ...
                  return (
                    <TableRow key={user.userId} className="hover:bg-slate-50/50">
                      ...
                      <TableCell>
                        <p className="text-sm font-medium text-slate-900">{user.totalPosts}</p>
                      </TableCell>
                      <TableCell>
        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">{selectedUser?.userId}</p>
            </div>
