...
export default function CoursesPage() {
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {Array.from({ length: 6 }).map((_, idx) => (
          <div
            ...
            className="bg-white/80 backdrop-blur-sm rounded-lg border border-slate-200/80 overflow-hidden"
          >
  ...
  return (
    <div className="space-y-6 p-8 min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 rounded-[50px]">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-lg border border-slate-200/80 p-4">
          ...
          <div className="max-w-7xl">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {courses.map((course) => (
                <div
                  key={course.id}
                  className="bg-white/80 backdrop-blur-sm rounded-lg border border-slate-200/80 overflow-hidden hover:shadow-xl transition-shadow"
                >
                  <div className="aspect-video bg-muted relative">
                    ...
                    <Badge
                      ...
                      className="absolute top-2 right-2 bg-slate-900/80 text-white"
                    >
            ...
            {courses.length === 0 && (
              <div className="text-center py-12 bg-white/80 backdrop-blur-sm rounded-lg border border-slate-200/80">
                <p className="text-muted-foreground">No courses found</p>
                <Button
                  onClick={openCreateDialog}
                  className="mt-4 bg-gradient-to-r from-slate-900 to-slate-800 hover:from-slate-800 hover:to-slate-700 text-white"
                >
                  <Plus className="h-4 w-4 mr-2" />
