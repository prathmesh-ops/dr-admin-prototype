...
export default function CommunityModerationPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-lg font-bold text-gray-900 tracking-tight">Community Moderation</h1>
        <p className="text-[13px] text-gray-500 mt-0.5">Approve / reject posts and manage users.</p>
      </div>
