    ...
    <div className="space-y-6 p-8 min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 rounded-[50px]">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <p className="text-[10px] uppercase tracking-[0.25em] text-slate-500 font-medium">Doctor Portal / Prescriptions</p>
        </div>
        <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">Prescription Management</h1>
            <p className="text-sm text-slate-600 mt-2 max-w-2xl">Generate and track digital prescription orders with clinical precision.</p>
          </div>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-[10px] uppercase tracking-[0.15em] text-blue-700 font-semibold">Active Prescriptions</p>
                </div>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-[10px] uppercase tracking-[0.15em] text-amber-700 font-semibold">Total Medicines</p>
                </div>
                <p className="text-3xl font-bold text-slate-900 mb-2">{totalMedicines}</p>
                <p className="text-xs text-amber-700/80 font-medium">Across all orders</p>
              </div>
