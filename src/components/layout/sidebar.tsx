...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Batch Management", href: "/dashboard/service/batch-management", icon: ListTodo },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Prescriptions", href: "/dashboard/doctor/prescriptions", icon: Pill },
      { title: "Issue Prescription", href: "/dashboard/doctor/issue-prescription", icon: FilePlus },
  ...
  {
    label: "Pharmacy",
    description: "Fulfilment flow",
    user_type: "pharmacist",
    items: [
      { title: "Dashboard", href: "/dashboard/pharmacy/dashboard", icon: Pill },
      // { title: "New Prescriptions", href: "/dashboard/pharmacy/new-prescriptions", icon: FilePlus },
      // { title: "Processing", href: "/dashboard/pharmacy/processing", icon: Loader2 },
      // { title: "Dispatch", href: "/dashboard/pharmacy/dispatch", icon: Truck },
      // { title: "Billing", href: "/dashboard/pharmacy/billing", icon: Receipt },
      // { title: "Inventory", href: "/dashboard/pharmacy/inventory", icon: Box },
      { title: "Product Management", href: "/dashboard/pharmacy/product-management", icon: Package },
      { title: "Orders", href: "/dashboard/pharmacy/orders", icon: ShoppingCart },
      { title: "Order Status", href: "/dashboard/pharmacy/order-status", icon: ClipboardCheck },
      { title: "Reports", href: "/dashboard/pharmacy/reports", icon: BarChart },
    ],
  },
  {
    label: "Finance",
